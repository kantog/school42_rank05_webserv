...
// Parses the raw HTTP request line by line:
// - Appends received bytes to the buffer
// - While there's a complete line, it calls the current parsing function (_currentFunction)
// - Handles method, headers, and finally the body
// TODO: This could be modularized into parseStartLine(), parseHeaders(), parseBody()
