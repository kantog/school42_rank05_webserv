...
// Builds the full HTTP response string that will be sent to the client.
// This includes the status line, all headers, a blank line, and the body (if any).
// Everything gets written to _responseString.
