...
// If the request targets a file, try to serve it.
// If it targets a directory, check for index files or build autoindex.
// Sets the correct status code and fills the HTTPResponse accordingly.
