...
// Returns the singleton instance of MyConfig.
// If it's the first time being called, it loads the config file.
// Ensures the server uses one consistent configuration throughout.
